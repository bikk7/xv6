...
_test-thread:     file format elf32-i386
...
int main(){
  ...
  1e:	68 85 0a 00 00       	push   $0xa85
  23:	e8 aa 03 00 00       	call   3d2 <open>
  ...
  33:	e8 c8 08 00 00       	call   900 <thread_create>
    if(pid != -1){
  38:	83 c4 10             	add    $0x10,%esp
  3b:	83 f8 ff             	cmp    $0xffffffff,%eax
  3e:	74 2d                	je     6d <main+0x6d>
  40:	89 c3                	mov    %eax,%ebx
        thread_join();
  42:	e8 79 09 00 00       	call   9c0 <thread_join>
        printf(1, "thread id = %d\n", pid);
  47:	50                   	push   %eax
  48:	53                   	push   %ebx
  49:	68 89 0a 00 00       	push   $0xa89
  4e:	6a 01                	push   $0x1
  50:	e8 ab 04 00 00       	call   500 <printf>
        printf(1, "global = %d\n", global);
  55:	a1 f8 0e 00 00       	mov    0xef8,%eax
  5a:	83 c4 0c             	add    $0xc,%esp
  5d:	50                   	push   %eax
  5e:	68 99 0a 00 00       	push   $0xa99
  63:	6a 01                	push   $0x1
  65:	e8 96 04 00 00       	call   500 <printf>
  6a:	83 c4 10             	add    $0x10,%esp
    }
    exit(); 
  6d:	e8 20 03 00 00       	call   392 <exit>
  72:	66 90                	xchg   %ax,%ax
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
...
int F(int n){
  ...
  89:	8b 75 08             	mov    0x8(%ebp),%esi
    if(n<0){
  8c:	85 f6                	test   %esi,%esi
  8e:	78 40                	js     d0 <F+0x50>
    }else if(n == 1 || n == 2){
  90:	8d 5e ff             	lea    -0x1(%esi),%ebx
  93:	83 fb 01             	cmp    $0x1,%ebx
  96:	76 58                	jbe    f0 <F+0x70>
  98:	83 e6 01             	and    $0x1,%esi
  9b:	31 ff                	xor    %edi,%edi
  9d:	83 ee 01             	sub    $0x1,%esi
        return F(n-1) + F(n-2);
  a0:	83 ec 0c             	sub    $0xc,%esp
  a3:	53                   	push   %ebx
  a4:	e8 d7 ff ff ff       	call   80 <F>
    if(n<0){
  a9:	83 c4 10             	add    $0x10,%esp
  ac:	01 c7                	add    %eax,%edi
  ae:	39 f3                	cmp    %esi,%ebx
  b0:	74 20                	je     d2 <F+0x52>
  b2:	83 eb 02             	sub    $0x2,%ebx
    }else if(n == 1 || n == 2){
  b5:	83 fb 01             	cmp    $0x1,%ebx
  b8:	77 e6                	ja     a0 <F+0x20>
}
  ba:	8d 65 f4             	lea    -0xc(%ebp),%esp
  bd:	83 c7 01             	add    $0x1,%edi
  ...
  d0:	31 ff                	xor    %edi,%edi
        printf(1, "please input a integer\n");
  d2:	83 ec 08             	sub    $0x8,%esp
  d5:	68 50 0a 00 00       	push   $0xa50
  da:	6a 01                	push   $0x1
  dc:	e8 1f 04 00 00       	call   500 <printf>
    return 0;
  e1:	83 c4 10             	add    $0x10,%esp
}
  e4:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
void worker(void* arg){
 ...
 109:	ff 30                	pushl  (%eax)
 10b:	68 68 0a 00 00       	push   $0xa68
 110:	6a 01                	push   $0x1
 112:	e8 e9 03 00 00       	call   500 <printf>
    global = F(15);
 117:	c7 04 24 0f 00 00 00 	movl   $0xf,(%esp)
 11e:	e8 5d ff ff ff       	call   80 <F>
    write(3,"hello\n",6);
 123:	83 c4 0c             	add    $0xc,%esp
    global = F(15);
 126:	a3 f8 0e 00 00       	mov    %eax,0xef8
    write(3,"hello\n",6);
 12b:	6a 06                	push   $0x6
 12d:	68 7e 0a 00 00       	push   $0xa7e
 132:	6a 03                	push   $0x3
 134:	e8 79 02 00 00       	call   3b2 <write>
    exit();
 139:	e8 54 02 00 00       	call   392 <exit>
 ...
 469:	85 d2                	test   %edx,%edx
{
 ...
 497:	f7 f1                	div    %ecx
 499:	0f b6 92 b0 0a 00 00 	movzbl 0xab0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6b4:	e9 8f fe ff ff       	jmp    548 <printf+0x48>
          s = "(null)";
 6b9:	bb a6 0a 00 00       	mov    $0xaa6,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d1:	a1 00 0f 00 00       	mov    0xf00,%eax
{
 ...
 70d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 70f:	a3 00 0f 00 00       	mov    %eax,0xf00
}
 714:	5b                   	pop    %ebx
 715:	5e                   	pop    %esi
 716:	5f                   	pop    %edi
 ...
 726:	72 ce                	jb     6f6 <free+0x26>
{
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 74a:	a3 00 0f 00 00       	mov    %eax,0xf00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 15 00 0f 00 00    	mov    0xf00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d6:	e8 f5 fe ff ff       	call   6d0 <free>
  return freep;
 7db:	8b 15 00 0f 00 00    	mov    0xf00,%edx
 ...
 804:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 807:	89 15 00 0f 00 00    	mov    %edx,0xf00
}
 ...
 819:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 00 0f 00 00 04 	movl   $0xf04,0xf00
 827:	0f 00 00 
 82a:	c7 05 04 0f 00 00 04 	movl   $0xf04,0xf04
 831:	0f 00 00 
    base.s.size = 0;
 834:	b8 04 0f 00 00       	mov    $0xf04,%eax
 839:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 840:	00 00 00 
...
void remove_thread(int* pid){
 860:	55                   	push   %ebp
 861:	b8 20 0f 00 00       	mov    $0xf20,%eax
...
void remove_thread(int* pid){
 ...
 899:	ff b3 24 0f 00 00    	pushl  0xf24(%ebx)
 89f:	e8 2c fe ff ff       	call   6d0 <free>
            threads[i].pid = 0;
 8a4:	c7 83 20 0f 00 00 00 	movl   $0x0,0xf20(%ebx)
 8ab:	00 00 00 
            threads[i].ustack = 0;
 8ae:	c7 83 24 0f 00 00 00 	movl   $0x0,0xf24(%ebx)
 8b5:	00 00 00 
            break;
 8b8:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 8bb:	c7 83 28 0f 00 00 00 	movl   $0x0,0xf28(%ebx)
 8c2:	00 00 00 
}
...
int findPos(){
 8d0:	55                   	push   %ebp
 8d1:	ba 20 0f 00 00       	mov    $0xf20,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
int findPos(){
 8d8:	89 e5                	mov    %esp,%ebp
    {
        if(threads[i].used == 0){
 8da:	8b 4a 08             	mov    0x8(%edx),%ecx
 8dd:	85 c9                	test   %ecx,%ecx
 8df:	74 10                	je     8f1 <findPos+0x21>
    for (int i = 0; i < NTHREAD; ++i)
 8e1:	83 c0 01             	add    $0x1,%eax
 8e4:	83 c2 0c             	add    $0xc,%edx
 8e7:	83 f8 04             	cmp    $0x4,%eax
 8ea:	75 ee                	jne    8da <findPos+0xa>
            return i;
        }
    }
    return -1;
...
00000900 <thread_create>:

int thread_create(void(*start_routine)(void*), void *arg){
 900:	55                   	push   %ebp
 901:	b8 20 0f 00 00       	mov    $0xf20,%eax
 906:	89 e5                	mov    %esp,%ebp
 908:	56                   	push   %esi
 909:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 90a:	31 db                	xor    %ebx,%ebx
int thread_create(void(*start_routine)(void*), void *arg){
 90c:	83 ec 10             	sub    $0x10,%esp
        if(threads[i].used == 0){
 90f:	8b 50 08             	mov    0x8(%eax),%edx
 912:	85 d2                	test   %edx,%edx
 914:	74 2a                	je     940 <thread_create+0x40>
    for (int i = 0; i < NTHREAD; ++i)
 916:	83 c3 01             	add    $0x1,%ebx
 919:	83 c0 0c             	add    $0xc,%eax
 91c:	83 fb 04             	cmp    $0x4,%ebx
 91f:	75 ee                	jne    90f <thread_create+0xf>
    int pos = findPos();
    if(pos == -1){
        printf(1,"Create thread failed! Perhaps because there are too many threads!\n");
 921:	83 ec 08             	sub    $0x8,%esp
 924:	68 dc 0a 00 00       	push   $0xadc
 929:	6a 01                	push   $0x1
 92b:	e8 d0 fb ff ff       	call   500 <printf>
        return -1;
 ...
 933:	8d 65 f8             	lea    -0x8(%ebp),%esp
        return -1;
 936:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 93b:	5b                   	pop    %ebx
 93c:	5e                   	pop    %esi
 93d:	5d                   	pop    %ebp
 ...
 943:	68 00 10 00 00       	push   $0x1000
 948:	e8 13 fe ff ff       	call   760 <malloc>
    int pid = clone(start_routine, arg, stack);
 94d:	83 c4 0c             	add    $0xc,%esp
    void *stack = malloc(PGSIZE);
 950:	89 c6                	mov    %eax,%esi
    int pid = clone(start_routine, arg, stack);
 952:	50                   	push   %eax
 953:	ff 75 0c             	pushl  0xc(%ebp)
 956:	ff 75 08             	pushl  0x8(%ebp)
 959:	e8 ec fa ff ff       	call   44a <clone>
    if(pid == -1){
 95e:	83 c4 10             	add    $0x10,%esp
 961:	83 f8 ff             	cmp    $0xffffffff,%eax
 964:	74 2a                	je     990 <thread_create+0x90>
        threads[pos].pid = pid;
 966:	8d 14 5b             	lea    (%ebx,%ebx,2),%edx
 969:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 96c:	89 b2 24 0f 00 00    	mov    %esi,0xf24(%edx)
        threads[pos].pid = pid;
 972:	89 82 20 0f 00 00    	mov    %eax,0xf20(%edx)
        threads[pos].used = 1; 
 978:	c7 82 28 0f 00 00 01 	movl   $0x1,0xf28(%edx)
 97f:	00 00 00 
}
 ...
 996:	68 c1 0a 00 00       	push   $0xac1
 99b:	6a 01                	push   $0x1
 99d:	e8 5e fb ff ff       	call   500 <printf>
        free(stack);
 9a2:	89 34 24             	mov    %esi,(%esp)
 9a5:	e8 26 fd ff ff       	call   6d0 <free>
 9aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
 9ad:	83 c4 10             	add    $0x10,%esp
}
 9b0:	8d 65 f8             	lea    -0x8(%ebp),%esp
 9b3:	5b                   	pop    %ebx
 9b4:	5e                   	pop    %esi
 9b5:	5d                   	pop    %ebp
 9b6:	c3                   	ret    
...
int thread_join(void){
 ...
 9c3:	53                   	push   %ebx
 9c4:	bb 20 0f 00 00       	mov    $0xf20,%ebx
 9c9:	83 ec 14             	sub    $0x14,%esp
    for(int i = 0; i < NTHREAD; ++i){
        if(threads[i].used == 1){
 9cc:	83 7b 08 01          	cmpl   $0x1,0x8(%ebx)
 9d0:	74 16                	je     9e8 <thread_join+0x28>
 9d2:	83 c3 0c             	add    $0xc,%ebx
    for(int i = 0; i < NTHREAD; ++i){
 9d5:	81 fb 50 0f 00 00    	cmp    $0xf50,%ebx
 9db:	75 ef                	jne    9cc <thread_join+0xc>
                remove_thread(&pid);
                return pid;
            }
        }
 ...
 9f9:	89 45 f4             	mov    %eax,-0xc(%ebp)
            if(pid > 0){
 9fc:	7e d4                	jle    9d2 <thread_join+0x12>
                remove_thread(&pid);
 9fe:	8d 45 f4             	lea    -0xc(%ebp),%eax
 a01:	83 ec 0c             	sub    $0xc,%esp
 a04:	50                   	push   %eax
 a05:	e8 56 fe ff ff       	call   860 <remove_thread>
                return pid;
 a0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a0d:	83 c4 10             	add    $0x10,%esp
 a10:	eb cd                	jmp    9df <thread_join+0x1f>
...
void printTCB(void){
 ...
 a23:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 a24:	31 db                	xor    %ebx,%ebx
void printTCB(void){
 a26:	83 ec 04             	sub    $0x4,%esp
    {
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 a29:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
 a2c:	ff 34 85 28 0f 00 00 	pushl  0xf28(,%eax,4)
 a33:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 a34:	83 c3 01             	add    $0x1,%ebx
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 a37:	68 d0 0a 00 00       	push   $0xad0
 a3c:	6a 01                	push   $0x1
 a3e:	e8 bd fa ff ff       	call   500 <printf>
    for (int i = 0; i < NTHREAD; ++i)
 a43:	83 c4 10             	add    $0x10,%esp
 a46:	83 fb 04             	cmp    $0x4,%ebx
 a49:	75 de                	jne    a29 <printTCB+0x9>
    }
