...
_myalloc:     file format elf32-i386
...
main(int argc, char *argv[]) {
  ...
  char* m3 = (char*)myalloc(1 * 4096);
  35:	e8 80 03 00 00       	call   3ba <myalloc>
  char* m4 = (char*)myalloc(7 * 4096);
  3a:	c7 04 24 00 70 00 00 	movl   $0x7000,(%esp)
  char* m3 = (char*)myalloc(1 * 4096);
  ...
  char* m5 = (char*)myalloc(9 * 4096);
  52:	e8 63 03 00 00       	call   3ba <myalloc>
  ...
  m1[0] = 'a';
  5f:	c6 03 61             	movb   $0x61,(%ebx)
  m2[2] = 'b';
  62:	c6 47 02 62          	movb   $0x62,0x2(%edi)
  m5[2] = 'b';
  66:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  m3[2] = 'b';
  69:	c6 40 02 62          	movb   $0x62,0x2(%eax)
  m4[2] = 'b';
  6d:	c6 46 02 62          	movb   $0x62,0x2(%esi)
  m5[2] = 'b';
  71:	c6 41 02 62          	movb   $0x62,0x2(%ecx)
  printf(1,"m1 : %s\n",m1);
  75:	53                   	push   %ebx
  76:	68 d0 09 00 00       	push   $0x9d0
  7b:	6a 01                	push   $0x1
  7d:	e8 fe 03 00 00       	call   480 <printf>
  myfree(m2);
  82:	89 3c 24             	mov    %edi,(%esp)
  85:	e8 38 03 00 00       	call   3c2 <myfree>

  //m2[1] = 'p';

  myfree(m4);
  8a:	89 34 24             	mov    %esi,(%esp)
  8d:	e8 30 03 00 00       	call   3c2 <myfree>
  
  // map(pid);
  sleep(5000);
  92:	c7 04 24 88 13 00 00 	movl   $0x1388,(%esp)
  99:	e8 0c 03 00 00       	call   3aa <sleep>
  myfree(m1);
  9e:	89 1c 24             	mov    %ebx,(%esp)
  a1:	e8 1c 03 00 00       	call   3c2 <myfree>
  myfree(m3);
  a6:	58                   	pop    %eax
  a7:	ff 75 e4             	pushl  -0x1c(%ebp)
  aa:	e8 13 03 00 00       	call   3c2 <myfree>
  myfree(m5);
  af:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  b2:	89 0c 24             	mov    %ecx,(%esp)
  b5:	e8 08 03 00 00       	call   3c2 <myfree>
  ...
  exit();
  ba:	e8 53 02 00 00       	call   312 <exit>
  bf:	90                   	nop
 ...
 3e9:	85 d2                	test   %edx,%edx
{
 ...
 417:	f7 f1                	div    %ecx
 419:	0f b6 92 e0 09 00 00 	movzbl 0x9e0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb d9 09 00 00       	mov    $0x9d9,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 e0 0d 00 00       	mov    0xde0,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 e0 0d 00 00       	mov    %eax,0xde0
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 e0 0d 00 00       	mov    %eax,0xde0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 e0 0d 00 00    	mov    0xde0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 e0 0d 00 00    	mov    0xde0,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 e0 0d 00 00    	mov    %edx,0xde0
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 e0 0d 00 00 e4 	movl   $0xde4,0xde0
 7a7:	0d 00 00 
 7aa:	c7 05 e4 0d 00 00 e4 	movl   $0xde4,0xde4
 7b1:	0d 00 00 
    base.s.size = 0;
 7b4:	b8 e4 0d 00 00       	mov    $0xde4,%eax
 7b9:	c7 05 e8 0d 00 00 00 	movl   $0x0,0xde8
 7c0:	00 00 00 
...
void remove_thread(int* pid){
 7e0:	55                   	push   %ebp
 7e1:	b8 00 0e 00 00       	mov    $0xe00,%eax
...
void remove_thread(int* pid){
 ...
 7ea:	56                   	push   %esi
 7eb:	53                   	push   %ebx
 7ec:	8b 4d 08             	mov    0x8(%ebp),%ecx
    {
        if(threads[i].used && threads[i].pid == *pid){
 7ef:	8b 58 08             	mov    0x8(%eax),%ebx
 7f2:	85 db                	test   %ebx,%ebx
 7f4:	74 06                	je     7fc <remove_thread+0x1c>
 7f6:	8b 31                	mov    (%ecx),%esi
 7f8:	39 30                	cmp    %esi,(%eax)
 7fa:	74 14                	je     810 <remove_thread+0x30>
    for (int i = 0; i < NTHREAD; ++i)
 7fc:	83 c2 01             	add    $0x1,%edx
 7ff:	83 c0 0c             	add    $0xc,%eax
 802:	83 fa 04             	cmp    $0x4,%edx
 805:	75 e8                	jne    7ef <remove_thread+0xf>
            threads[i].ustack = 0;
            threads[i].used = 0;
            break;
        }
 ...
 810:	8d 1c 52             	lea    (%edx,%edx,2),%ebx
 813:	83 ec 0c             	sub    $0xc,%esp
 816:	c1 e3 02             	shl    $0x2,%ebx
 819:	ff b3 04 0e 00 00    	pushl  0xe04(%ebx)
 81f:	e8 2c fe ff ff       	call   650 <free>
            threads[i].pid = 0;
 824:	c7 83 00 0e 00 00 00 	movl   $0x0,0xe00(%ebx)
 82b:	00 00 00 
            threads[i].ustack = 0;
 82e:	c7 83 04 0e 00 00 00 	movl   $0x0,0xe04(%ebx)
 835:	00 00 00 
            break;
 838:	83 c4 10             	add    $0x10,%esp
            threads[i].used = 0;
 83b:	c7 83 08 0e 00 00 00 	movl   $0x0,0xe08(%ebx)
 842:	00 00 00 
}
 845:	8d 65 f8             	lea    -0x8(%ebp),%esp
 848:	5b                   	pop    %ebx
 849:	5e                   	pop    %esi
 84a:	5d                   	pop    %ebp
 84b:	c3                   	ret    
...
int findPos(){
 850:	55                   	push   %ebp
 851:	ba 00 0e 00 00       	mov    $0xe00,%edx
    for (int i = 0; i < NTHREAD; ++i)
...
int findPos(){
 858:	89 e5                	mov    %esp,%ebp
    {
        if(threads[i].used == 0){
 85a:	8b 4a 08             	mov    0x8(%edx),%ecx
 85d:	85 c9                	test   %ecx,%ecx
 85f:	74 10                	je     871 <findPos+0x21>
    for (int i = 0; i < NTHREAD; ++i)
 861:	83 c0 01             	add    $0x1,%eax
 864:	83 c2 0c             	add    $0xc,%edx
 867:	83 f8 04             	cmp    $0x4,%eax
 86a:	75 ee                	jne    85a <findPos+0xa>
            return i;
        }
    }
    return -1;
 86c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 871:	5d                   	pop    %ebp
 872:	c3                   	ret    
...
int thread_create(void(*start_routine)(void*), void *arg){
 880:	55                   	push   %ebp
 881:	b8 00 0e 00 00       	mov    $0xe00,%eax
...
int thread_create(void(*start_routine)(void*), void *arg){
 88c:	83 ec 10             	sub    $0x10,%esp
        if(threads[i].used == 0){
 88f:	8b 50 08             	mov    0x8(%eax),%edx
 892:	85 d2                	test   %edx,%edx
 894:	74 2a                	je     8c0 <thread_create+0x40>
    for (int i = 0; i < NTHREAD; ++i)
 896:	83 c3 01             	add    $0x1,%ebx
 899:	83 c0 0c             	add    $0xc,%eax
 89c:	83 fb 04             	cmp    $0x4,%ebx
 89f:	75 ee                	jne    88f <thread_create+0xf>
    int pos = findPos();
    if(pos == -1){
        printf(1,"Create thread failed! Perhaps because there are too many threads!\n");
 8a1:	83 ec 08             	sub    $0x8,%esp
 8a4:	68 0c 0a 00 00       	push   $0xa0c
 8a9:	6a 01                	push   $0x1
 8ab:	e8 d0 fb ff ff       	call   480 <printf>
        return -1;
 ...
 8c3:	68 00 10 00 00       	push   $0x1000
 8c8:	e8 13 fe ff ff       	call   6e0 <malloc>
    int pid = clone(start_routine, arg, stack);
 8cd:	83 c4 0c             	add    $0xc,%esp
    void *stack = malloc(PGSIZE);
 ...
 8d9:	e8 ec fa ff ff       	call   3ca <clone>
    if(pid == -1){
 8de:	83 c4 10             	add    $0x10,%esp
 8e1:	83 f8 ff             	cmp    $0xffffffff,%eax
 8e4:	74 2a                	je     910 <thread_create+0x90>
        threads[pos].pid = pid;
 8e6:	8d 14 5b             	lea    (%ebx,%ebx,2),%edx
 8e9:	c1 e2 02             	shl    $0x2,%edx
        threads[pos].ustack = stack;
 8ec:	89 b2 04 0e 00 00    	mov    %esi,0xe04(%edx)
        threads[pos].pid = pid;
 8f2:	89 82 00 0e 00 00    	mov    %eax,0xe00(%edx)
        threads[pos].used = 1; 
 8f8:	c7 82 08 0e 00 00 01 	movl   $0x1,0xe08(%edx)
 8ff:	00 00 00 
}
 ...
 916:	68 f1 09 00 00       	push   $0x9f1
 91b:	6a 01                	push   $0x1
 91d:	e8 5e fb ff ff       	call   480 <printf>
        free(stack);
 922:	89 34 24             	mov    %esi,(%esp)
 925:	e8 26 fd ff ff       	call   650 <free>
 92a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 92d:	83 c4 10             	add    $0x10,%esp
}
 930:	8d 65 f8             	lea    -0x8(%ebp),%esp
 933:	5b                   	pop    %ebx
 934:	5e                   	pop    %esi
 935:	5d                   	pop    %ebp
 936:	c3                   	ret    
...
int thread_join(void){
 ...
 943:	53                   	push   %ebx
 944:	bb 00 0e 00 00       	mov    $0xe00,%ebx
 949:	83 ec 14             	sub    $0x14,%esp
    for(int i = 0; i < NTHREAD; ++i){
        if(threads[i].used == 1){
 94c:	83 7b 08 01          	cmpl   $0x1,0x8(%ebx)
 950:	74 16                	je     968 <thread_join+0x28>
 952:	83 c3 0c             	add    $0xc,%ebx
    for(int i = 0; i < NTHREAD; ++i){
 955:	81 fb 30 0e 00 00    	cmp    $0xe30,%ebx
 95b:	75 ef                	jne    94c <thread_join+0xc>
                remove_thread(&pid);
                return pid;
            }
        }
 ...
 968:	8d 43 04             	lea    0x4(%ebx),%eax
 96b:	83 ec 0c             	sub    $0xc,%esp
 96e:	50                   	push   %eax
 96f:	e8 5e fa ff ff       	call   3d2 <join>
            if(pid > 0){
 ...
 979:	89 45 f4             	mov    %eax,-0xc(%ebp)
            if(pid > 0){
 97c:	7e d4                	jle    952 <thread_join+0x12>
                remove_thread(&pid);
 97e:	8d 45 f4             	lea    -0xc(%ebp),%eax
 981:	83 ec 0c             	sub    $0xc,%esp
 984:	50                   	push   %eax
 985:	e8 56 fe ff ff       	call   7e0 <remove_thread>
                return pid;
 98a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 98d:	83 c4 10             	add    $0x10,%esp
 990:	eb cd                	jmp    95f <thread_join+0x1f>
...
void printTCB(void){
 ...
 9a3:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 9a4:	31 db                	xor    %ebx,%ebx
void printTCB(void){
 9a6:	83 ec 04             	sub    $0x4,%esp
    {
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 9a9:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
 9ac:	ff 34 85 08 0e 00 00 	pushl  0xe08(,%eax,4)
 9b3:	53                   	push   %ebx
    for (int i = 0; i < NTHREAD; ++i)
 9b4:	83 c3 01             	add    $0x1,%ebx
        printf(1,"TCB %d:%d\n",i,threads[i].used);
 9b7:	68 00 0a 00 00       	push   $0xa00
 9bc:	6a 01                	push   $0x1
 9be:	e8 bd fa ff ff       	call   480 <printf>
    for (int i = 0; i < NTHREAD; ++i)
 9c3:	83 c4 10             	add    $0x10,%esp
 9c6:	83 fb 04             	cmp    $0x4,%ebx
 9c9:	75 de                	jne    9a9 <printTCB+0x9>
    }
    
}
 9cb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 9ce:	c9                   	leave  
 9cf:	c3                   	ret    
